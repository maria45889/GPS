...
export const HeaderBar = ({ selectedVehicle, onMenuClick }) => {
  ...
  return (
    <div className="relative z-20 flex min-h-[72px] items-center justify-between gap-3 border-b border-[#26343b] bg-[#151e23] px-4 py-3 text-[13px] sm:px-6">
      ...
      <div className="header-fleet-selector flex items-center gap-2">
        <div
        ...
        >
          <span className="header-fleet-name text-[12px] font-semibold text-[#e2ebe6]">Scooter Enterprise</span>
        ...
        <button
          ...
          aria-label="Acciones"
        >
          <MoreHorizontal size={17} className="header-action-icon" />
          <span className="header-action-label">Acciones</span>
        </button>
      </div>
